...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.SHT = 1
        self.data_bn = nn.BatchNorm1d(in_channels * self.num_point * num_person) # number of spherical harmonics, 2 * V because of lokal environment for each joint
    ...
    def forward(self, x):
        ...
        x = x_rot.view(N*M,T,C,V).permute(0,2,1,3).contiguous()
