...
class four_unit_tcn(nn.Module):
    ...
    def forward(self, x):
        ...
        fourier_input = fourier_input.permute(0,2,1,3) # over joint
        fourier_2 = torch.fft.rfft2(fourier_input,dim=1) 
        fourier_2 = fourier_2.abs() # retrieve magnitude
        fourier_2 = fourier_2.reshape(N,T,33,V).permute(0,2,1,3)
