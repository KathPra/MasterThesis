...
## Baseline
file1="csub/global_SHT2/log.txt"
...
# local_SHT1
file2="csub/global_SHT2a/log.txt"
...
# local SHT w/ l = 1
file3="csub/global_SHT2b/log.txt"
...
label_list =  ["Mag.","Mag. & Phase", "Real & Imag.","Phase","Real", "Imag" ]

plot_loss([loss1, loss2, loss3, loss4, loss5, loss6],label_list, "local_SHT_input")
plot_acc([top1acc1, top1acc2, top1acc3, top1acc4, top1acc5,top1acc6], label_list, "local_SHT_input")
