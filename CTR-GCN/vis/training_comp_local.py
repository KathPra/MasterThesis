...
## Local coordinates
file1a="csub/local_SHT1b/log.txt"
...
label_list =  ["Baseline","Local Coord.", "Mag. & Phase","Real & Imag." ]

plot_loss([loss1, loss1a, loss2, loss3],label_list, "local_SHT_form")
plot_acc([top1acc1, top1acc1a, top1acc2, top1acc3], label_list, "local_SHT_form")
