...
class symmetry_module(nn.Module):
    def __init__(self, in_channels, out_channels, stride = 1):
        ...
        self.fnn1 = nn.Linear(in_channels,in_channels)
        self.fnn2 = nn.Linear(in_channels,self.time_channels)
    ...
    def forward(self,x):
        ...
        f = self.fnn1(f) # re-arrange frequencies
        f = self.fnn2(f) # # decrease time dim
