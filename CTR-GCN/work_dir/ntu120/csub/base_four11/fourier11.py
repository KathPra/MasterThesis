...
class four_unit_tcn(nn.Module):
    ...
    def forward(self, x):
        ...
        # Arms w/o hands
        fourier_al = fourier_input[:,:, :, 12:16]
        fourier_al = torch.fft.rfft(fourier_al,dim=1)
        fourier_al = fourier_al.abs()
        fourier_al = fourier_al[:,1:,:,:]
        fourier_ar = fourier_input[:,:,:, 16:20]
        fourier_ar = torch.fft.rfft(fourier_ar,dim=1)
        fourier_ar= fourier_ar.abs()
        fourier_ar = fourier_ar[:,1:,:,:]

        arm_dif = fourier_ar-fourier_al
