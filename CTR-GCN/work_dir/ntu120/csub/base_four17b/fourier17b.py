...
class four_unit_tcn(nn.Module):
    ...
    def forward(self, x):
        ...
        fourier_1d = torch.fft.rfft(fourier_input,dim=2)
        fourier_phase = fourier_1d.angle() # retrieve phase
        fourier_phase = fourier_phase[:,:,1:,:]
        ...
        fourier_phase = self.bnf(self.convf(fourier_phase))
        ...
        x = torch.cat([x1,fourier_phase], dim =2)
